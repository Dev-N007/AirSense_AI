...
def create_pipeline_notebook():
    print("Generating airsense_end_to_end_pipeline.ipynb...")
    ...
    # Cell 6: Code Preprocessing Checks
    cells.append({
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
    ...
    # Cell 10: Code Feature Engineering
    cells.append({
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
    ...
    output_path = "airsense_end_to_end_pipeline.ipynb"
